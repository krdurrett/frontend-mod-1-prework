...
if (dogAge <= 2) {
  console.log('You have a little puppy!');
} else if (dogAge >= 10) {
  console.log('You have an elderly doggo!');
} else{
...
for yourself!
Yes! I read the little article about them and it was also touched on in the JavaScript and JQuery book.
