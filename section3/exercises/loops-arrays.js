...
var animalsTwo = ["Kitty", "Lizard", "Penguin"];

for (var i = 0; i < animalsTwo.length; i++) {
  console.log("The" + " " + animalsTwo[i] + " " + "is awesome!");
}


// YOU DO: Create an array of foods and then iterate over that array to log "Add
// <food> to shopping list" for each food item.
var foods = ["Milk", "Eggs", "Bread", "Lunch Meat", "Grapes", "Carrots", "Apples"];
